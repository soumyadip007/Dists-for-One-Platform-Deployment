...
/*!****************************!*\
  !*** ./src/app/app.gql.ts ***!
  \****************************/
/*! exports provided: AuditWebsite, Autorun, FetchScore, FetchProjectDetails, FetchProjects, FetchProjectLHR, FetchProjectBuilds, FetchProjectBranches, Upload */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AuditWebsite", function() { return AuditWebsite; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FetchProjectDetails", function() { return FetchProjectDetails; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FetchProjects", function() { return FetchProjects; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FetchProjectLHR", function() { return FetchProjectLHR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FetchProjectBuilds", function() { return FetchProjectBuilds; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FetchProjectBranches", function() { return FetchProjectBranches; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Upload", function() { return Upload; });
/* harmony import */ var graphql_tag__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! graphql-tag */ "UYTu");

const AuditWebsite = graphql_tag__WEBPACK_IMPORTED_MODULE_0__["default"] `
  mutation AuditWebsite($property: LighthouseInput) {
    auditWebsite(property: $property)
  }
`;
const Autorun = graphql_tag__WEBPACK_IMPORTED_MODULE_0__["default"] `
  subscription Autorun {
    autorun
  }
`;
const FetchScore = graphql_tag__WEBPACK_IMPORTED_MODULE_0__["default"] `
...
`;
const FetchProjectDetails = graphql_tag__WEBPACK_IMPORTED_MODULE_0__["default"] `
...
`;
const FetchProjects = graphql_tag__WEBPACK_IMPORTED_MODULE_0__["default"] `
...
`;
const FetchProjectLHR = graphql_tag__WEBPACK_IMPORTED_MODULE_0__["default"] `
...
`;
const FetchProjectBuilds = graphql_tag__WEBPACK_IMPORTED_MODULE_0__["default"] `
...
`;
const FetchProjectBranches = graphql_tag__WEBPACK_IMPORTED_MODULE_0__["default"] `
...
`;
const Upload = graphql_tag__WEBPACK_IMPORTED_MODULE_0__["default"] `
...
/* harmony import */ var _components_home_home_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/home/home.component */ "UQUS");
...
/* harmony import */ var _graphql_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./graphql.module */ "4KHl");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash */ "LvDl");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _app_gql__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./app.gql */ "5O9P");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "kU1M");
...
class AppService extends _graphql_module__WEBPACK_IMPORTED_MODULE_0__["GraphQLModule"] {
    constructor(apollo) {
        super();
        this.apollo = apollo;
        // Trigger to perform the audit for the website
        this.auditWebsite = (property) => {
            return this.apollo.mutate({
                mutation: _app_gql__WEBPACK_IMPORTED_MODULE_2__["AuditWebsite"],
                variables: {
                    property
                }
        ...
        this.fetchScore = (auditId) => {
            return this.apollo.watchQuery({
                query: _app_gql__WEBPACK_IMPORTED_MODULE_2__["FetchScore"],
                variables: {
                    auditId
                }
            }).result().then(result => lodash__WEBPACK_IMPORTED_MODULE_1__["cloneDeep"](result.data.listLHScore));
        };
        // Fetch & Verify Project details of valid project
        this.fetchProjects = (serverBaseUrl) => {
            return this.apollo.watchQuery({
                query: _app_gql__WEBPACK_IMPORTED_MODULE_2__["FetchProjects"],
                variables: {
                    serverBaseUrl
                }
            }).result().then(result => lodash__WEBPACK_IMPORTED_MODULE_1__["cloneDeep"](result.data));
        };
        // Fetch & Verify Project details of valid project
        this.fetchProjectDetails = (serverBaseUrl, buildToken) => {
            return this.apollo.watchQuery({
                query: _app_gql__WEBPACK_IMPORTED_MODULE_2__["FetchProjectDetails"],
                variables: {
                    serverBaseUrl,
                    buildToken
                }
        ...
        this.fetchProjectLHR = (serverBaseUrl, projectID, buildID) => {
            return this.apollo.watchQuery({
                query: _app_gql__WEBPACK_IMPORTED_MODULE_2__["FetchProjectLHR"],
                variables: {
                    serverBaseUrl,
                    projectID,
                    buildID
        ...
        this.fetchProjectBranches = (serverBaseUrl, projectID) => {
            return this.apollo.watchQuery({
                query: _app_gql__WEBPACK_IMPORTED_MODULE_2__["FetchProjectBranches"],
                variables: {
                    serverBaseUrl,
                    projectID
                }
        ...
        this.upload = (property) => {
            return this.apollo.mutate({
                mutation: _app_gql__WEBPACK_IMPORTED_MODULE_2__["Upload"],
                variables: {
                    property
                }
            }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((result) => result.data));
    ...
    autorun() {
        return this.apollo.subscribe({ query: _app_gql__WEBPACK_IMPORTED_MODULE_2__["Autorun"] })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((result) => result.data.autorun));
    }
}
AppService.ɵfac = function AppService_Factory(t) { return new (t || AppService)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](apollo_angular__WEBPACK_IMPORTED_MODULE_5__["Apollo"])); };
AppService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjectable"]({ token: AppService, factory: AppService.ɵfac, providedIn: 'root' });
...
/* harmony import */ var app_app_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! app/app.service */ "F5nt");
...
function HomeComponent_button_33_Template(rf, ctx) { if (rf & 1) {
    const _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "button", 27);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function HomeComponent_button_33_Template_button_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r6); const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r5.auditWebsite(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](1, " Generate Report ");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} if (rf & 2) {
    const ctx_r0 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("disabled", !ctx_r0.validUrl);
} }
function HomeComponent_button_34_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](4, "span", 32);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](5, "span", 33);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](6, " Generating Report ");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} }
function HomeComponent_span_38_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function HomeComponent_span_38_Template_input_ngModelChange_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r10); const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r9.selectedPreset = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpropertyInterpolate"]("value", preset_r7.value);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngModel", ctx_r2.selectedPreset);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](preset_r7.name);
} }
function HomeComponent_div_39_app_outlined_pie_graph_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "app-outlined-pie-graph", 40);
} if (rf & 2) {
    const report_r12 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpropertyInterpolate"]("score", report_r12.score);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpropertyInterpolate"]("name", report_r12.name);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpropertyInterpolate"]("type", report_r12.class);
} }
function HomeComponent_div_39_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](2, HomeComponent_div_39_app_outlined_pie_graph_2_Template, 1, 3, "app-outlined-pie-graph", 38);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](3, "app-lhcard-legend", 39);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} if (rf & 2) {
    const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngForOf", ctx_r3.lhciScores);
} }
function HomeComponent_div_51_option_16_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "option", 61);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} if (rf & 2) {
    const project_r15 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("value", project_r15.id);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"]("", project_r15.name, " ");
} }
function HomeComponent_div_51_option_23_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "option", 61);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} if (rf & 2) {
    const project_r16 = ctx.$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("value", project_r16.branch);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](project_r16.branch);
} }
function HomeComponent_div_51_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function HomeComponent_div_51_Template_button_click_3_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r18); const ctx_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r17.toggleModal = false; });
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](4, "i", 44);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](5, "header", 45);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](6, "h1", 46);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](7, "Upload results to Lighthouse CI Server ");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](11, "label", 50);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](12, "Project");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](13, "select", 51);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function HomeComponent_div_51_Template_select_ngModelChange_13_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r18); const ctx_r19 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r19.projectID = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](14, "option", 52);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](15, "Select Project");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](16, HomeComponent_div_51_option_16_Template, 2, 2, "option", 53);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](17, "div", 49);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](18, "label", 54);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](19, "Branch");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](20, "select", 55);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function HomeComponent_div_51_Template_select_ngModelChange_20_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r18); const ctx_r20 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r20.property.currentBranch = $event; })("click", function HomeComponent_div_51_Template_select_click_20_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r18); const ctx_r21 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); ctx_r21.validUploadConfig = false; ctx_r21.fetchProjectBranches(); return ctx_r21.fetchProjectDetails(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](21, "option", 52);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](22, "Select Branch");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](23, HomeComponent_div_51_option_23_Template, 2, 2, "option", 53);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](24, "div", 56);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](25, "label", 57);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](26, "Build Token");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](27, "input", 58);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function HomeComponent_div_51_Template_input_ngModelChange_27_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r18); const ctx_r22 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r22.property.buildToken = $event; })("blur", function HomeComponent_div_51_Template_input_blur_27_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r18); const ctx_r23 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r23.fetchProjectDetails(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](28, "footer", 59);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](29, "button", 60);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function HomeComponent_div_51_Template_button_click_29_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r18); const ctx_r24 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r24.upload(ctx_r24.property); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngModel", ctx_r4.projectID);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngForOf", ctx_r4.projects);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](4);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngModel", ctx_r4.property.currentBranch);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngForOf", ctx_r4.projectBranches);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](4);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngModel", ctx_r4.property.buildToken);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("disabled", !ctx_r4.validUploadConfig);
} }
const Ansi = __webpack_require__(/*! ansi-to-html */ "YavU");
class HomeComponent {
    constructor(appService) {
        ...
        this.selectedPreset = 'lighthouse:recommended';
        this.presets = [
            {
                name: 'All',
        ...
        this.fetchProjectDetails = () => {
            if (this.property.buildToken) {
                this.appService
                    .fetchProjectDetails(environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].LH_SERVER_URL, this.property.buildToken)
                    .then((response) => {
                    var _a, _b;
                    if (((_a = response.fetchProjectDetails) === null || _a === void 0 ? void 0 : _a.id) === this.projectID) {
                        this.validUploadConfig = true;
                        window.OpNotification.success({
                            subject: `Valid Token`,
                            body: `Token valid for project ${(_b = response.fetchProjectDetails) === null || _b === void 0 ? void 0 : _b.name}.`,
                        });
                    }
                    else {
                        this.validUploadConfig = false;
        ...
        this.updateProgress = () => {
            this.appService.autorun().subscribe((progress) => {
        ...
        this.linkParser = (progress) => {
            const replacePattern1 = /(\b(https?|):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gi;
        ...
        this.fetchProjects = () => {
            this.appService
                .fetchProjects(environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].LH_SERVER_URL)
                .then((responses) => {
                this.projects = responses.listLHProjects;
            });
        };
        this.fetchProjectBranches = () => {
            if (this.projectID) {
                this.appService
                    .fetchProjectBranches(environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].LH_SERVER_URL, this.projectID)
                    .then((responses) => {
        ...
        this.upload = (property) => {
            const uploadProperty = Object.assign({ auditId: this.auditId, serverBaseUrl: environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].LH_SERVER_URL, authorName: this.user.fullName, authorEmail: this.user.email }, property);
            this.toggleModal = false;
            this.appService.upload(uploadProperty).subscribe((response) => {
                if (response.upload) {
                    window.OpNotification.success({
                        subject: `Started upload of LHR Report`,
                        body: `LHR Upload to ${environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].LH_SERVER_URL} in progress.`,
                    });
                }
            });
        };
    ...
    get user() {
        var _a;
        return (_a = window === null || window === void 0 ? void 0 : window.OpAuthHelper) === null || _a === void 0 ? void 0 : _a.getUserInfo();
    }
}
HomeComponent.ɵfac = function HomeComponent_Factory(t) { return new (t || HomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](app_app_service__WEBPACK_IMPORTED_MODULE_2__["AppService"])); };
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], decls: 52, vars: 7, consts: [[1, "lighthouse-block"], [1, "pf-u-text-align-center", "pf-u-font-size-2xl", "pf-u-mt-xl", "pf-u-mb-4xl"], [1, "pf-l-flex", "pf-m-nowrap"], [1, "pf-l-flex__item", "pf-l-flex", "pf-m-column", "pf-m-align-items-center"], [1, "lighthouse-step-dot", "pf-u-ml-4xl", "pf-u-mr-4xl"], [1, "pf-u-text-align-center", "pf-u-font-size-lg", "pf-m-spacer-xs"], [1, "pf-u-text-align-center", "pf-u-color-400", "pf-u-w-75"], [1, "pf-u-mt-4xl", "pf-u-mb-md"], [1, "pf-l-bullseye"], [1, "pf-c-input-group", "pf-u-w-33", "pf-u-mr-md"], ["type", "search", "id", "sites", "name", "sites", "aria-label", "Enter webpage url", "placeholder", "Enter web page url with http/https", "required", "", 1, "pf-c-form-control", "pf-m-search", "lighthouse-search", 3, "ngModel", "ngModelChange"], ["class", "pf-c-button pf-m-progress pf-m-primary", "type", "button", 3, "disabled", "click", 4, "ngIf"], ["class", "pf-c-button pf-m-progress pf-m-in-progress pf-m-primary", "type", "button", 4, "ngIf"], [1, "pf-l-flex", "pf-m-justify-content-center", "pf-u-mb-xl", "pf-m-align-items-center"], [1, "pf-u-font-weight-bold"], [4, "ngFor", "ngForOf"], ["class", "pf-u-mb-xl", 4, "ngIf"], [1, "pf-c-code-block", "pf-u-pb-md", "lighthouse-code-container"], [1, "pf-c-code-block__header", "lighthouse-code-header"], [1, "pf-c-code-block__actions"], [1, "pf-c-code-block__actions-item"], ["type", "button", "aria-label", "Upload to lighthouse ci server", 1, "pf-c-button", "pf-m-plain", 3, "click"], ["aria-hidden", "true", 1, "fas", "fa-upload"], ["id", "codeBlock", 1, "pf-c-code-block__content", "lighthouse-code-block"], [1, "pf-c-code-block__pre"], [1, "pf-c-code-block__code", 3, "innerHtml"], ["class", "pf-c-backdrop", 4, "ngIf"], ["type", "button", 1, "pf-c-button", "pf-m-progress", "pf-m-primary", 3, "disabled", "click"], ["type", "button", 1, "pf-c-button", "pf-m-progress", "pf-m-in-progress", "pf-m-primary"], [1, "pf-c-button__progress"], ["role", "progressbar", "aria-valuetext", "Loading...", 1, "pf-c-spinner", "pf-m-md"], [1, "pf-c-spinner__clipper"], [1, "pf-c-spinner__lead-ball"], [1, "pf-c-spinner__tail-ball"], ["type", "radio", "name", "preset", 3, "value", "ngModel", "ngModelChange"], ["for", "preset"], [1, "pf-u-mb-xl"], [1, "pf-l-flex", "pf-m-align-items-center", "pf-m-justify-content-center"], [3, "score", "name", "type", 4, "ngFor", "ngForOf"], ["align", "center"], [3, "score", "name", "type"], [1, "pf-c-backdrop"], ["role", "dialog", "aria-modal", "true", "aria-labelledby", "upload-results-title", "aria-describedby", "upload-results-description", 1, "pf-c-modal-box", "pf-u-w-50"], ["type", "button", "aria-label", "Close", 1, "pf-c-button", "pf-m-plain", 3, "click"], ["aria-hidden", "true", 1, "fas", "fa-times"], [1, "pf-c-modal-box__header"], ["id", "upload-results-title", 1, "pf-c-modal-box__title"], [1, "pf-c-modal-box__body"], [1, "pf-l-grid", "pf-m-gutter"], [1, "pf-l-grid__item", "pf-m-6-col"], ["for", "project-select"], ["id", "project-select", "name", "project-select", "aria-label", "project select", "required", "", 1, "pf-c-form-control", "pf-m-placeholder", 3, "ngModel", "ngModelChange"], ["value", "", "disabled", "", "selected", ""], [3, "value", 4, "ngFor", "ngForOf"], ["for", "project-branch"], ["id", "project-branch", "name", "project-branch", "aria-label", "project branch", "required", "", 1, "pf-c-form-control", "pf-m-placeholder", 3, "ngModel", "ngModelChange", "click"], [1, "pf-l-grid__item", "pf-m-12-col"], ["for", "build-token"], ["type", "text", "id", "buildToken", "aria-label", "Build Token", "placeholder", "Enter Build Token", "name", "buildToken", "required", "", 1, "pf-c-form-control", 3, "ngModel", "ngModelChange", "blur"], [1, "pf-c-modal-box__footer"], [1, "pf-c-button", "pf-m-primary", 3, "disabled", "click"], [3, "value"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "section", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](2, " Measure performance of your application ");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](9, " Run Tests on your site ");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](10, "div", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](11, " Enter your site's url to see how well it performs across all audits. ");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](17, " Look at what matters ");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](18, "div", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](19, " See your site's performance across the areas you care about. ");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](25, " Get tips for improving ");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](26, "div", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](27, " Each test comes with helpful steps to improve your site's results. ");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function HomeComponent_Template_input_ngModelChange_31_listener($event) { return ctx.sites = $event; })("ngModelChange", function HomeComponent_Template_input_ngModelChange_31_listener($event) { return ctx.validateUrl($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](32, "div");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](33, HomeComponent_button_33_Template, 2, 1, "button", 11);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](34, HomeComponent_button_34_Template, 7, 0, "button", 12);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](37, "Presets :");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](38, HomeComponent_span_38_Template, 6, 3, "span", 15);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](39, HomeComponent_div_39_Template, 4, 1, "div", 16);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function HomeComponent_Template_button_click_44_listener() { return ctx.toggleModal = true; });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](47, "pre", 24);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](48, "                ");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](49, "code", 25);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](50, "\n            ");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](51, HomeComponent_div_51_Template, 31, 6, "div", 26);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](31);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngModel", ctx.sites);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngIf", !ctx.loading);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngIf", ctx.loading);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](4);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngForOf", ctx.presets);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngIf", ctx.showScore);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](10);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("innerHtml", ctx.auditProgress, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsanitizeHtml"]);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngIf", ctx.toggleModal);
    } }, directives: [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["RequiredValidator"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["NgModel"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgForOf"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["RadioControlValueAccessor"], _shared_components_lhcard_legend_lhcard_legend_component__WEBPACK_IMPORTED_MODULE_5__["LHCardLegendComponent"], _shared_components_outlined_pie_graph_outlined_pie_graph_component__WEBPACK_IMPORTED_MODULE_6__["OutlinedPieGraphComponent"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["SelectControlValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["NgSelectOption"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ɵangular_packages_forms_forms_z"]], styles: [".lighthouse-block[_ngcontent-%COMP%] {\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n}\n.lighthouse-step-dot[_ngcontent-%COMP%] {\n  background-color: #fff;\n  border-radius: 999em;\n  width: 45px;\n  height: 45px;\n  box-shadow: 0 2px 5px 0 rgba(0, 0, 0, 0.26);\n  line-height: 1;\n  font-size: 30px;\n  position: relative;\n  cursor: pointer;\n  display: inline-block;\n}\n.lighthouse-step-dot[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  position: absolute;\n  left: 0;\n  top: 65%;\n  height: 100%;\n  width: 100%;\n  text-align: center;\n  margin-top: -22px;\n  color: #000;\n}\n.lighthouse-code-container[_ngcontent-%COMP%] {\n  flex: 0 0 40vh;\n  max-height: 40vh;\n  height: 100%;\n}\n.lighthouse-code-block[_ngcontent-%COMP%] {\n  height: 100%;\n  overflow: auto;\n}\n.lighthouse-code-block[_ngcontent-%COMP%]   pre[_ngcontent-%COMP%] {\n  white-space: pre-line;\n}\n.lighthouse-code-header[_ngcontent-%COMP%] {\n  position: sticky;\n}\n.lighthouse-search[_ngcontent-%COMP%] {\n  background-color: #efefef;\n  border-radius: 20px;\n  border: 0;\n  color: #3c3f42;\n  outline: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
var entities = __webpack_require__(/*! entities */ "ibbH");
...
HomeModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineInjector"]({ imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _home_routing_module__WEBPACK_IMPORTED_MODULE_3__["HomeRoutingModule"], app_shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"]]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵsetNgModuleScope"](HomeModule, { declarations: [_components_home_home_component__WEBPACK_IMPORTED_MODULE_1__["HomeComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _home_routing_module__WEBPACK_IMPORTED_MODULE_3__["HomeRoutingModule"], app_shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"]] }); })();
